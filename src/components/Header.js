            ...
            <header className="row expanded">
                <div className="small-12 columns">
                    <ul className="menu menu-left">
                        <li className="menu-item logo"><Link to="/">Emploi</Link></li>
                    </ul>
                    <ul className="menu">
                    ...
                    <div onClick={this.changeMenuState.bind(this)} id="menu"
                         className="medium-rm large-rm"/>
                    <div id="sign" className="entry-btn medium-rm large-rm"/>
                    <ul className="menu menu-right">
                        <li className="menu-item delay-2"><Link to="/projects">Проекты</Link>
                            <div></div>
                        </li>
                        <li className="menu-item delay-3"><Link to="/students">Студенты</Link>
                        </li>
                    </ul>
                </div>
            </header>
