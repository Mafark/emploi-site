      ...
      <div className="block wide shadow-1 small-12 columns row">
        ...
        <div className="small-12 medium-12 large-padding-left-3 columns">
          <div className="small-12 medium-4 padding-right-3 columns small-no-padding">
            ...
            <img src={this.props.project.avatar} className="small-8 medium-12 border columns no-padding margin-bottom" alt="LOD" />
            <div className="space-1 small-2 medium-rm large-rm columns" />
          </div>
          <div className="small-12 medium-8 large-padding-left-3 columns no-padding">
            <h2 className="small-12 full-name small-text-center no-margin no-padding columns">{this.props.project.name}</h2>
            <Link to={site + '/users/' + this.props.project.leader.id} className="small-12 small-text-center no-padding columns">{this.props.project.leader.name + ' ' + this.props.project.leader.surname}</Link>
          </div>
