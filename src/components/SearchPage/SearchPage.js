        ...
        if (this.timeout === false && !(str === '' && this.props.state.search.searchSelectedTags.length === 0)) {
            ...
            setTimeout(function () {
                ...
                if (this.location === '/students') {
                    this.previewData = getStudentsSearchPreview();
            ...
            }.bind(this), this.timeBetweenRequests);
        }
    }
            ...
            <div className="page row expanded">
                <ReactCSSTransitionGroup
                    ...
                    <div className="content row">
                        ...
                        <div className="space-2 small-8 large-0 columns left"></div>
                        ...
                        <div className="space-2 small-8 columns left"></div>
                        <div className="small-12 medium-12 large-8 columns large-padding-right left">
                            <TagResults location={this.location}/>
                        </div>
                        <div className="small-12 medium-12 large-8 space-2 columns large-padding-right left"></div>
                        <div className="small-12 medium-12 large-8 columns large-padding-right left">
