...
import {getStudentsSearchPreview, getProjectsSearchPreview} from '../../common/ajaxRequests';
...
class ConfigurationForm extends Component {
    ...
    getPreview(){
        if (this.props.location === '/students') {
            this.props.updateSearchData(getStudentsSearchPreview().data);
        ...
        return (
            <div className="form small-12 columns no-padding">
                ...
                <div className="small-12 medium-6 large-12 columns">
                    <label htmlFor="course" className="small-12 center columns">Курс</label>
                    <select ref={(select) => this.course = select} onChange={this.changeConfig.bind(this)} id="course" className="small-12 columns" type="text" required>
                ...
                <div className="small-12 medium-6 large-12 columns">
                    <label htmlFor="course" className="small-12 center columns">Институт</label>
                    <select ref={(select) => this.institute = select} onChange={this.changeConfig.bind(this)} id="course" className="small-12 columns" type="text" required>
                ...
                <div className="small-12 medium-12 large-12 columns">
                    <label htmlFor="interests" className="small-12 center columns">Область знаний</label>
                    ...
                    <div className="space-2 small-12 "></div>
                </div>
